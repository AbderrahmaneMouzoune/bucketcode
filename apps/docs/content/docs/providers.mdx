...
your server, serve through the custom domain. [Without a server](/docs/no-server) sets the same
bucket up for the CLI alone — no deployment in the middle at all.
