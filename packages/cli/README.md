...
It is built on [`bucketcode`](https://www.npmjs.com/package/bucketcode) as a primitive, and has no
...
the operations bucketcode actually needs and reports what happened, rather than reading your policy
